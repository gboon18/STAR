...
for file_path in file_paths:
        ...
        file_pattern = "Ru_mTerms_f_*_dca_{}_nhitsfit_{}_nsp_{}_m2low_{}_m2up_{}_ptmax_{}_ymax_{}_detefflow_err_{}_deteffhigh_err_{}.root"
	...
	line_Ru = None
	with open("./Ru_GoodRunNumbers.list") as f_ru:
	    i = 0;
	    line = ''
	    for line in f_ru:
	        line_Ru = line.split("\t")
	...
	for A in root_files:
	    for line in line_Ru:
	        if A.find(line) != -1:
	            list_Ru.append(os.path.join(file_path, A))
